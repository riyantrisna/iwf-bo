...
class SponsorController extends Controller
{
    ...
    public function data(Request $request)
	{
        ...
        if(!empty($keyword)){
            ...
            $query = $list->where(function($q) use($keyword) {
                $q->where('sponsors.full_name', 'LIKE', $keyword)
                ->orWhere('sponsors.link_url', 'LIKE', $keyword)
                ->orWhere('sponsors.category', 'LIKE', $keyword)
                ;
            });
        }
    ...
    public function add(Request $request){
        ...
        if(empty($request->title)){
            ...
            $check_data = Sponsor::select('id')->where('title', $request->title)->first();
    ...
    public function editView(Request $request, $id){
        ...
        $detail = Sponsor::where('id', $id)->first();
    ...
    public function edit(Request $request){
        ...
        if(empty($request->title)){
            ...
            $check_data = Sponsor::select('id')->where('title', $request->title)->whereNotIn('id', [$request->id])->first();
            if(!empty($check_data->id)){
                $validation = $validation && false;
        ...
        if($validation){
            ...
            if($upload['status']){
                ...
                $post = Sponsor::where('id', $request->id)->first();
    ...
    public function delete(Request $request, $id){
        ...
        $delete = Sponsor::where('id', $id)->delete();
        if($delete){
            $path = env("WEB_UPLOAD")."post/";
